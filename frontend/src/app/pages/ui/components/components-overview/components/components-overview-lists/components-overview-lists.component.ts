...
export class ComponentsOverviewListsComponent implements OnInit {
  ...
  <mat-list-item>
    <img mat-list-avatar src="assets/img/demo/1.jpg">
    <h3 matLine>John</h3>
    <p matLine>
      <span>Brunch?</span>
  ...
  <mat-list-item>
    <img mat-list-avatar src="assets/img/demo/2.jpg">
    <h3 matLine>Peter</h3>
    <p matLine>
  ...
  <mat-list-item>
    <img mat-list-avatar src="assets/img/demo/3.jpg">
    <h3 matLine>Nancy</h3>
    <p matLine>
      <span>Oui oui</span>
  ...
  <mat-list-item>
    <img mat-list-avatar src="assets/img/demo/4.jpg">
    <h3 matLine>Frank</h3>
    <p matLine>
  ...
  <mat-list-item>
    <img mat-list-avatar src="assets/img/demo/5.jpg">
